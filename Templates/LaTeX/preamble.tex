...
\NewDocumentCommand\Definition{mm}{%
    \begin{definition}{#1}{}
        #2
    \end{definition}
}
...
\NewDocumentCommand\Corollary{mm}{%
    \begin{corollary}{#1}{}
        #2
    \end{corollary}
}
...
\NewDocumentCommand\Exercise{mm}{%
    \begin{excercise}{#1}{}
        #2
    \end{excercise}
}
...
\NewDocumentCommand\Note{O{Note:-}m}{%
    \begin{note*}{#1}{}
        #2
    \end{note*}
}
